public class FindGuitarTester {
  ...
  public static void main(String[] args) {
    ...
    Guitar whatErinLikes = new Guitar(null, 0, Builder.FENDER, Model.STRATOCASTOR, Wood.ALDER, Wood.ALDER,
        Type.ELECTRIC);
  ...
  private static void initializeInventory(Inventory inventory) {
    ...
    inventory.addGuitar("76531", 6295.95, Builder.MARTIN, Model.OM_28, Wood.BRAZILIAN_ROSEWOOD, Wood.ADIRONDACK,
        Type.ACOUSTIC);
    inventory.addGuitar("70108276", 2295.95, Builder.GIBSON, Model.LES_PAUL, Wood.MAHOGANY, Wood.MAPLE, Type.ELECTRIC);
    inventory.addGuitar("82765501", 1890.95, Builder.GIBSON, Model.SG_61_REISSUE, Wood.MAHOGANY, Wood.MAHOGANY,
        Type.ELECTRIC);
    inventory.addGuitar("77023", 6275.95, Builder.MARTIN, Model.D_28, Wood.BRAZILIAN_ROSEWOOD, Wood.ADIRONDACK,
        Type.ACOUSTIC);
    ...
    inventory.addGuitar("6 29584", 2100.95, Builder.PRS, Model.DAVE_NAVARRO_SIGNATURE, Wood.MAHOGANY, Wood.MAPLE,
        Type.ELECTRIC);
  }
}
